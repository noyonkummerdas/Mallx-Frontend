    ...
    <div className="group relative wow-card p-0 transition-all duration-700 rounded-[2rem] overflow-hidden border border-slate-100/50 hover:z-10">
      ...
      <div className="px-6 pb-8 pt-5 font-sans">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/catalog/products/${product._id}`} className="flex items-center gap-1.5 px-4 py-2 bg-slate-50 border border-slate-100 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 rounded-xl transition-all shadow-sm active:scale-95 group/details">
            <span className="text-[9px] font-black uppercase tracking-[0.15em]">Details</span>
            {/* <ArrowUpRight className="w-3.5 h-3.5 opacity-40 group-hover/details:opacity-100 transition-opacity" /> */}
          </Link>
        </div>
