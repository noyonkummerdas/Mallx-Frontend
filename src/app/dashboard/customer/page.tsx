         ...
         <div className="space-y-8">
            ...
            <section className="bg-white border border-slate-200 rounded-2xl p-10 shadow-sm">
               <div className="flex items-center justify-between mb-8">
                  ...
                  <a href="/orders" className="bg-slate-50 hover:bg-slate-100 text-slate-900 border border-slate-200 px-4 py-2 rounded-xl text-sm font-black uppercase tracking-widest transition-all text-center">Orders</a>
               </div>
                     ...
                     <div key={order._id} className="flex items-center justify-between p-5 rounded-xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-lg hover:shadow-slate-200/40 transition-all group">
                        <div className="flex items-center gap-4">
                           ...
                           <div>
                              ...
                              <p className="text-sm font-bold text-slate-400 tracking-widest">{new Date(order.createdAt).toLocaleDateString()} · {order.items?.length || 0} ITEM</p>
                           </div>
                        </div>
