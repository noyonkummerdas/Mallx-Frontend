      ...
      <main className="flex-1 p-10 overflow-y-auto">
        <div className="max-w-2xl mx-auto">
          <header className="mb-8">
            <h1 className="text-lg font-black tracking-tight mb-1 text-slate-900 uppercase leading-none">Merchant Onboarding</h1>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-[11px] font-bold focus:outline-none focus:ring-2 focus:ring-indigo-600/20 transition-all font-sans"
                    />
                  </div>
                </div>
