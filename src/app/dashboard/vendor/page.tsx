...
<header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
  ...
  <div className="flex gap-3">
     <button className="bg-slate-900 px-5 py-2.5 rounded-xl text-[10px] uppercase tracking-widest text-white hover:bg-black transition-all shadow-lg shadow-slate-900/10">Create Product</button>
     <button 
           ...
           <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm cursor-pointer hover:border-slate-900 transition-all relative overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-slate-500 text-[8px] uppercase tracking-widest mt-1">{shopData?.data?.category?.name || "Tier 1 Merchant"}</p>
                 </div>
              </div>
           </div>
        </div>
