  ...
  return (
    <main className="min-h-screen bg-gray-200 text-slate-900 p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-sm font-black mb-8 tracking-tight text-slate-900 uppercase">Shopping Bag</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              cartItems.map((item: any) => (
                <div key={item._id} className="bg-white border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row gap-4 items-center shadow-sm group hover:border-indigo-600/20 transition-all">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                     <h3 className="font-bold text-sm mb-1 uppercase tracking-tight text-slate-900">{item.productId?.name}</h3>
          ...
          <div className="relative">
            <div className="sticky top-8 bg-indigo-600 rounded-xl p-6 shadow-lg shadow-indigo-600/30 text-white">
              <h2 className="text-sm font-black mb-6 tracking-tighter uppercase">Cart Summary</h2>
              ...
              <Link href="/shopping/checkout">
                 <button disabled={cartItems.length === 0} className="w-full bg-white text-indigo-600 font-black py-3 rounded-lg shadow-md hover:bg-slate-50 transition-all active:scale-95 disabled:opacity-50 uppercase tracking-widest text-xs">
                    Ship Items Now
                 </button>
              </Link>
            </div>
