        ...
        <div className="max-w-8xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:flex items-center gap-9 border-r border-slate-100 pr-9 mr-2">
              <Link href="/catalog/products" className="text-[14px] font-black   text-slate-900 hover:text-indigo-600 hover:-translate-y-0.5 transition-all duration-300">Marketplace</Link>
